 ...
 *
 */
public final class TestingExtendedComplexTypeBuilder extends AbstractExtendedComplexTypeBuilder {

	private final TestingBaseClassManager m;

	public TestingExtendedComplexTypeBuilder(TestingBaseClassManager m) {
		this.m = m;
	}

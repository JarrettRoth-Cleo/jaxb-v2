...
public final class CTypeRef implements TypeRef<NType, NClass> {
	 ...
	 *
	 * <xs:simpleType name="parent"> <xs:restriction base="xs:date"/>
	 * </xs:simpleType>
	 * <xs:simpleType name="child"> <xs:restriction base="parent"/>
	 * </xs:simpleType>
	 *
	...
	/**
	 * Inside XJC, use {@link #defaultValue} that has context information. This
	 * method is to override the one defined in the runtime model.
	 *
	 * @see #defaultValue
	 */
	...
	public void setType(CNonElement type) {
		this.type = type;
	}
}

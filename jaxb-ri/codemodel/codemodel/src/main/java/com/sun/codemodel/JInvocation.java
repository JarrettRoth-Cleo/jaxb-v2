...
public final class JInvocation extends JExpressionImpl implements JStatement {
	 ...
	 * invocation.) This allows {@link JMethod#name(String) the name of the
	 ...
	 * 
	 * @param c
	 *            Type of the object to be created. If this type is an array
	 *            type, added arguments are treated as array initializer. Thus

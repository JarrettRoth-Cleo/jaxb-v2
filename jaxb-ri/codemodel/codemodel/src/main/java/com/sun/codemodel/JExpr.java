...
public abstract class JExpr {
	...
	public static JExpression dotclass(JClass cl) {
		return new JExpressionDotClass(cl);
	}
	...
	/**
	 * Returns a reference to "this", an implicit reference to the current
	 * object.
	 */
	 ...
	 * 
	 * <p>
	 * Be warned that there is a danger in using this method, as it obfuscates
	 * the object model.
	 */

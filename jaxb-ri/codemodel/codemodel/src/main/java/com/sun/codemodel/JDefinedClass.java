...
public class JDefinedClass extends JClass implements JDeclaration, JClassContainer, JGenerifiable, JAnnotatable, JDocCommentable {
	 ...
	 * nested class, this is {@link JDefinedClass}. If this is an anonymous
	...
	/**
	 * Set of enum constants that are keyed by names. In Java, enum constant
	 * order is actually significant, because of order ID they get. So let's
	 * preserve the order.
	 */
		...
		for (JClass o = superClass.outer(); o != null; o = o.outer()) {
			if (this == o) {
				throw new IllegalArgumentException(
						"Illegal class inheritance loop." + "  Outer class " + this.name + " may not subclass from inner class: " + o.name());
			}
		}
	...
	/**
	 * Returns all the fields declred in this class. The returned {@link Map} is
	...
	/**
	 * Creates, if necessary, and returns the instance initializer for this
	 * class.
	 *
	 * @return JBlock containing initialization statements for this class
	 */
	...
	/**
	 * Add a method to the list of method members of this JDefinedClass
	 * instance.
	 *
	 * @param mods
	 ...
	 * 
	 * <p>
	 * This feature could be used to generate code that refers to class X,
	 * without actually generating X.java.
	 */
	public void hide() {
		hideFile = true;
	}
	 ...
	 * 
	 * This method can be used to add methods/fields that are not generated by
	 * CodeModel. This method should be used only as the last resort.
	 */

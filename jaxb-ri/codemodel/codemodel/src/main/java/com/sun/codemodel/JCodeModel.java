 ...
 *
 * There are a few exceptions to this, most notably building {@link JExpression}
 * s, but generally you work with CodeModel in a top-down fashion.
 *
...
public final class JCodeModel {
	 ...
	 * user-specified class that may or may not exist, and only thing known
	 * about it is a class name.
	 */
	 ...
	 * 
	 * @deprecated The naming convention doesn't match the rest of the
	 *             CodeModel. Use {@link #anonymousClass(JClass)} instead.
	 */
	@Deprecated
	 ...
	 * {@link Integer#TYPE} to its boxed type (such as <tt>Integer.class</tt>)
	 */

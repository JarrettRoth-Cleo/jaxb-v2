...
public final class JAnnotationUse extends JAnnotationValue {
	 ...
	 * 
	 * @link #annotationParam(java.lang.String, java.lang.Class<? extends
	 ...
	 *
	 * @param value
	 *            The JExpression which provides the contant value for this
	 *            annotation
	 * @return The JAnnotationUse. More member value pairs can be added to it
	 *         using the same or the overloaded methods.
	 *
	...
	// JAnnotationUse annotationUse = new
	// JAnnotationUse(owner().ref(className));
	// return annotationUse;
	// }

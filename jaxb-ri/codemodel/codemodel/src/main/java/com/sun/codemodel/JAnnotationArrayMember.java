...
public final class JAnnotationArrayMember extends JAnnotationValue implements JAnnotatable {
	...
	public Collection<JAnnotationUse> annotations() {
		// this invocation is invalid if the caller isn't adding annotations
		// into an array
	...
	/**
	 * Adds an annotation member to this annotation array This can be used for
	 * e.g &#64;XmlCollection(values= &#64;XmlCollectionItem(type=Foo.class))
	 * 
	 * @param value

...
public abstract class JAXBRIContext extends JAXBContext {
	 ...
	 *
	 * <p>
	 * {@link JAXBContext#newInstance(Class[]) JAXBContext.newInstance()}
	 * methods may return other JAXB providers that are not compatible with the
	 * JAX-RPC RI. This method guarantees that the JAX-WS RI will finds the JAXB
	 * RI.
	 *
	 * @param classes
	 *            Classes to be bound. See
	 *            {@link JAXBContext#newInstance(Class[])} for the meaning.
	 * @param typeRefs
	 *            See {@link #TYPE_REFERENCES} for the meaning of this
	 *            parameter. Can be null.
	 * @param subclassReplacements
	 *            See {@link #SUBCLASS_REPLACEMENTS} for the meaning of this
	 *            parameter. Can be null.
	 * @param defaultNamespaceRemap
	 *            See {@link #DEFAULT_NAMESPACE_REMAP} for the meaning of this
	 *            parameter. Can be null (and should be null for ordinary use of
	 *            JAXB.)
	 * @param c14nSupport
	 *            See {@link #CANONICALIZATION_SUPPORT} for the meaning of this
	 *            parameter.
	 * @param ar
	 *            See {@link #ANNOTATION_READER} for the meaning of this
	 *            parameter. Can be null.
	 * @since JAXB 2.1 EA2
	 */
	public static JAXBRIContext newInstance(@NotNull Class[] classes, @Nullable Collection<TypeReference> typeRefs,
			@Nullable Map<Class, Class> subclassReplacements, @Nullable String defaultNamespaceRemap, boolean c14nSupport,
	 ...
	 *            See {@link #XMLACCESSORFACTORY_SUPPORT} for the meaning of
	 *            this parameter.
	 * @param allNillable
	 *            See {@link #TREAT_EVERYTHING_NILLABLE} for the meaning of this
	 *            parameter.
	 * @param retainPropertyInfo
	 *            See {@link #RETAIN_REFERENCE_TO_INFO} for the meaning of this
	 *            parameter.
	 * @param supressAccessorWarnings
	 *            See {@link #SUPRESS_ACCESSOR_WARNINGS} for the meaning of this
	 *            parameter.
	 */
	public static JAXBRIContext newInstance(@NotNull Class[] classes, @Nullable Collection<TypeReference> typeRefs,
			@Nullable Map<Class, Class> subclassReplacements, @Nullable String defaultNamespaceRemap, boolean c14nSupport,
			@Nullable RuntimeAnnotationReader ar, boolean xmlAccessorFactorySupport, boolean allNillable, boolean retainPropertyInfo,
			boolean supressAccessorWarnings) throws JAXBException {
		Map<String, Object> properties = new HashMap<String, Object>();
		if (typeRefs != null)
			properties.put(JAXBRIContext.TYPE_REFERENCES, typeRefs);
		if (subclassReplacements != null)
			properties.put(JAXBRIContext.SUBCLASS_REPLACEMENTS, subclassReplacements);
		if (defaultNamespaceRemap != null)
			properties.put(JAXBRIContext.DEFAULT_NAMESPACE_REMAP, defaultNamespaceRemap);
		if (ar != null)
	...
	/**
	 * If the given object is bound to an element in XML by JAXB, returns the
	 * element name.
	 *
	 * @return null if the object is not bound to an element.
	 ...
	 * {@link TypeReference}.
	 *
	 * @return null if the specified reference is not given to
	 *         {@link JAXBRIContext#newInstance}.
	 *
	 * @since 2.0 EA1
	 */
	 ...
	 *
	 * @return always a valid non-null instance.
	 *
	 * @since 2.0 EA1
	 */
	...
	/**
	 * Gets a {@link RawAccessor} for the specified element property of the
	 * specified wrapper bean class.
	 *
	 * <p>
	 * This method is designed to assist the JAX-RPC RI fill in a wrapper bean
	 * (in the doc/lit/wrap mode.) In the said mode, a wrapper bean is supposed
	 * to only have properties that match elements, and for each element that
	 * appear in the content model there's one property.
	 *
	 * <p>
	 * Therefore, this method takes a wrapper bean and a tag name that
	 * identifies a property on the given wrapper bean, then returns a
	 * {@link RawAccessor} that allows the caller to set/get a value from the
	 * property of the bean.
	 *
	 * <p>
	 * This method is not designed for a performance. The caller is expected to
	 * cache the result.
	 *
	 * @param <B>
	 ...
	 * @return always return non-null valid accessor object.
	 * @throws JAXBException
	 *             if the specified wrapper bean is not bound by JAXB, or if it
	 *             doesn't have an element property of the given name.
	 *
	 * @since 2.0 EA1
	 */
	 ...
	 *
	 * <p>
	 * When JAXB is used to marshal into sub-trees, it declares these namespace
	 * URIs at each top-level element that it marshals.
	 *
	 ...
	 *
	 * <p>
	 * The caller can use the additionalElementDecls parameter to add element
	 * declarations to the generate schema. For example, if the JAX-RPC passes
	 ...
	 *
	 * @param tr
	 *            must not be null. This must be one of the
	 *            {@link TypeReference}s specified in the
	 *            {@link JAXBRIContext#newInstance} method.
	 *
	 * @throws IllegalArgumentException
	 *             if the parameter is null or not a part of the
	 *             {@link TypeReference}s specified in the
	 *             {@link JAXBRIContext#newInstance} method.
	 *
	 * @return null if the referenced type is an anonymous and therefore doesn't
	 *         have a name.
	 */
	 ...
	 *
	 * @return may be null, if the runtime is loaded by a class loader that
	 *         doesn't support the access to the manifest informatino.
	 */
	public abstract @NotNull String getBuildId();

	/**
	 * Generates the episode file that represents the binding known to this
	 * {@link JAXBContext}, so that XJC can later do separate compilation.
	 *
	 * <p>
	 * Episode file is really just a JAXB customization file, except that
	 * currently we use the RI-specific SCD to refer to schema components.
	 *
	 * @param output
	...
	/**
	 * Allows you to access the runtime model information of the JAXB XML/Java
	 * binding.
	 *
	 * <p>
	 * This is useful for doing a deeper integration with the JAXB RI. For more
	 * information about the model, see https://jaxb2-reflection.dev.java.net/
	 *
	 * @since 2.1.10
	 */
	 ...
	 *
	 * <p>
	 * This method faithfully implements the name mangling rule as specified in
	 * the JAXB spec.
	 *
	 * <p>
	 * In JAXB, a collision with a Java reserved word (such as "return") never
	 * happens. Accordingly, this method may return an identifier that collides
	 * with reserved words.
	 *
	 * <p>
	 * Use <tt>JJavaName.isJavaIdentifier(String)</tt> to check for such
	 * collision.
	 *
	 * @return Typically, this method returns "nameLikeThis".
	 */
	public static @NotNull String mangleNameToVariableName(@NotNull String localName) {
		return NameConverterProvider.getStandard().toVariableName(localName);
	}
	...
	public static @NotNull String mangleNameToClassName(@NotNull String localName) {
		return NameConverterProvider.getStandard().toClassName(localName);
	}
	 ...
	 * <p>
	 * This method faithfully implements the name mangling rule as specified in
	 * the JAXB spec. This method works like
	 * {@link #mangleNameToClassName(String)} except that it looks for
	 * "getClass" and returns something else.
	 *
	 * @return Typically, this method returns "NameLikeThis".
	 */
	public static @NotNull String mangleNameToPropertyName(@NotNull String localName) {
		return NameConverterProvider.getStandard().toPropertyName(localName);
	}
	 ...
	 * @return The use of {@code baseType} in {@code type}. or null if the type
	...
	/**
	 * The property that you can specify to {@link JAXBContext#newInstance} to
	 * reassign the default namespace URI to something else at the runtime.
	 *
	 * <p>
	 * The value of the property is {@link String}, and it is used as the
	 * namespace URI that succeeds the default namespace URI.
	 *
	 * @since 2.0 EA1
	 */
	...
	/**
	 * The property that you can specify to {@link JAXBContext#newInstance} to
	 * put additional JAXB type references into the {@link JAXBContext}.
	 *
	 * <p>
	 * The value of the property is {@link Collection}&lt;{@link TypeReference}
	 * >. Those {@link TypeReference}s can then be used to create {@link Bridge}
	 * s.
	 *
	 * <p>
	 * This mechanism allows additional element declarations that were not a
	 * part of the schema into the created {@link JAXBContext}.
	 *
	 * @since 2.0 EA1
	 */
	...
	/**
	 * The property that you can specify to {@link JAXBContext#newInstance} and
	 * {@link Marshaller#setProperty(String, Object)} to enable the c14n
	 * marshalling support in the {@link JAXBContext}.
	 *
	 * Boolean
	 * 
	...
	/**
	 * The property that you can specify to {@link JAXBContext#newInstance} to
	 * allow unmarshaller to honor <tt>xsi:nil</tt> anywhere, even if they are
	...
	/**
	 * The property that you can specify to {@link JAXBContext#newInstance} to
	 * use alternative {@link RuntimeAnnotationReader} implementation.
	 *
	 * @since 2.1 EA2
	 */
	...
	/**
	 * The property that you can specify to {@link JAXBContext#newInstance} to
	 * specify specific classes that replace the reference to generic classes.
	 *
	 * <p>
	 ...
	 * enable support of XmlAccessorFactory annotation in the
	 * {@link JAXBContext}.
	 *
	 * @since 2.1 EA2
	 */
	...
	/**
	 * Supress security warnings when trying to access fields through
	 * reflection.
	 *
	 * Boolean
	 * 
